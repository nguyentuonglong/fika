package vn.com.corp.fika.util.customview;
...
public class DynamicSeekBarView extends LinearLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int infoDrawable = a.getResourceId(R.styleable.DynamicSeekBarView_dsbv_infoDrawable, 0);
            ...
            if (!isHideInfo) {
                ...
                if (infoBackgroundColor != 0) {
                    ...
                    if (infoRadius != 0)
                        shape.setCornerRadius(infoRadius);
                    shape.setColor(getColorValue(R.color.color_heart));
                    tvInfo.setBackground(shape);
                }

                if (infoDrawable != 0) {
                    tvInfo.setBackgroundResource(infoDrawable);
                }

                new Handler().postDelayed(() -> setInfoPosition(progressValueSeekBar), 500);
